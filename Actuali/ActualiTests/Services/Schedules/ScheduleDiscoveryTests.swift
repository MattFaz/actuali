...
struct ScheduleDiscoveryTests {
    ...
    @Test func rankFallsOffWithDistance() {
        let a = DayDate(yyyymmdd: 20_260_815)!
        #expect(ScheduleDiscovery.rank(a, a) == 1.0)
        #expect(ScheduleDiscovery.rank(a, DayDate(yyyymmdd: 20_260_816)!) == 0.5)
        // Direction doesn't matter.
        #expect(ScheduleDiscovery.rank(a, DayDate(yyyymmdd: 20_260_814)!) == 0.5)
    }

    @Test func exactMonthlyRepeatIsDetected() {
        let occurrences = [
            (date: DayDate(yyyymmdd: 20_260_615)!, transactions: [candidate(20_260_615, -125_000)]),
            (date: DayDate(yyyymmdd: 20_260_715)!, transactions: [candidate(20_260_715, -125_000)]),
            (date: DayDate(yyyymmdd: 20_260_815)!, transactions: [candidate(20_260_815, -125_000)]),
        ]
    ...
    @Test func amountsWithinTheThresholdStillMatchButAreNotExact() {
        let occurrences = [
            (date: DayDate(yyyymmdd: 20_260_615)!, transactions: [candidate(20_260_615, -100_000)]),
            (date: DayDate(yyyymmdd: 20_260_715)!, transactions: [candidate(20_260_715, -103_000)]),
            (date: DayDate(yyyymmdd: 20_260_815)!, transactions: [candidate(20_260_815, -100_000)]),
        ]
    ...
    @Test func amountsOutsideTheThresholdDoNotMatch() {
        let occurrences = [
            (date: DayDate(yyyymmdd: 20_260_615)!, transactions: [candidate(20_260_615, -100_000)]),
            (date: DayDate(yyyymmdd: 20_260_715)!, transactions: [candidate(20_260_715, -150_000)]),
            (date: DayDate(yyyymmdd: 20_260_815)!, transactions: [candidate(20_260_815, -100_000)]),
        ]
    ...
    @Test func aMissingOccurrenceDisqualifiesThePattern() {
        let occurrences = [
            (date: DayDate(yyyymmdd: 20_260_615)!, transactions: [candidate(20_260_615, -100_000)]),
            (date: DayDate(yyyymmdd: 20_260_715)!, transactions: [ScheduleDiscovery.Candidate]()),
            (date: DayDate(yyyymmdd: 20_260_815)!, transactions: [candidate(20_260_815, -100_000)]),
        ]
        #expect(ScheduleDiscovery.match(
            occurrences: occurrences, config: monthlyConfig(20_260_615),
    ...
    @Test func differentPayeesDoNotMatchEachOther() {
        let occurrences = [
            (date: DayDate(yyyymmdd: 20_260_615)!, transactions: [candidate(20_260_615, -100_000, payee: "p1")]),
            (date: DayDate(yyyymmdd: 20_260_715)!, transactions: [candidate(20_260_715, -100_000, payee: "p2")]),
            (date: DayDate(yyyymmdd: 20_260_815)!, transactions: [candidate(20_260_815, -100_000, payee: "p1")]),
        ]
        #expect(ScheduleDiscovery.match(
            occurrences: occurrences, config: monthlyConfig(20_260_615),
            accountId: "acct-1"
    ...
    @Test func datesThatDriftScoreLowerAndAreNotExact() {
        let occurrences = [
            (date: DayDate(yyyymmdd: 20_260_615)!, transactions: [candidate(20_260_616, -100_000)]),
            (date: DayDate(yyyymmdd: 20_260_715)!, transactions: [candidate(20_260_715, -100_000)]),
            (date: DayDate(yyyymmdd: 20_260_815)!, transactions: [candidate(20_260_815, -100_000)]),
        ]
        let match = try! #require(ScheduleDiscovery.match(
            occurrences: occurrences, config: monthlyConfig(20_260_615),
    ...
    @Test func indexWindowsTwoDaysEitherSide() {
        ...
        let near = index.near(DayDate(yyyymmdd: 20_260_815)!, days: 2)
