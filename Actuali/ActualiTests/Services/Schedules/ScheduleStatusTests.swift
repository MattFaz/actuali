...
struct ScheduleStatusTests {
    ...
    @Test func exactAndAutoPostingSchedulesGetNoLookback() throws {
        let next = try #require(DayDate(yyyymmdd: 20_260_813))
    ...
    @Test func manualApproximateSchedulesAllowTwoDaysEarly() throws {
        let next = try #require(DayDate(yyyymmdd: 20_260_813))
        #expect(ScheduleStatusCalculator.occurrenceMatchStartDate(
    ...
    @Test func recurringSchedulesUseFrequencyBoundedLookback() throws {
        let next = try #require(DayDate(yyyymmdd: 20_260_813))
        #expect(ScheduleStatusCalculator.occurrenceMatchStartDate(
