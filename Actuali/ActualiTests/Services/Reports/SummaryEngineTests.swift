...
struct SummaryEngineTests {
    ...
    @Test func sumsTransactionsInRange() {
        let transactions = [
            ...
            tx(date: 20_260_315, amount: -2000),
            tx(date: 20_260_420, amount: -500)
        ]
    ...
    @Test func excludesTransactionsOutsideRange() {
        let transactions = [
            tx(date: 20_260_101, amount: -1000),
            tx(date: 20_251_231, amount: -9999) // prior year
        ]
        let meta = SummaryMeta(
            name: nil,
            timeFrame: WidgetTimeFrame(start: nil, end: nil, mode: .yearToDate),
    ...
    @Test func excludesTombstonedTransactions() {
        let transactions = [
            tx(date: 20_260_301, amount: -1000),
            tx(date: 20_260_302, amount: -2000, tombstone: true)
        ]
    ...
    @Test func appliesCategoryFilter() {
        let transactions = [
            tx(date: 20_260_301, amount: -1000, category: "groceries"),
            tx(date: 20_260_302, amount: -5000, category: "rent")
        ]
    ...
    @Test func transferConditionExcludesTransfers() throws {
        // Recreates the user's "Spent This Month" widget condition:
        // {"field":"transfer","op":"is","value":false} -> exclude transfers
        let transactions = [
            Transaction(id: "1", accountId: "a1", date: 20_260_501, amount: -1000,
            ...
            Transaction(id: "2", accountId: "a1", date: 20_260_502, amount: -5000,
                        payeeId: nil, payeeName: nil, categoryId: nil, categoryName: nil,
                        notes: nil, cleared: false, reconciled: false,
    ...
    @Test func avgPerTransactDividesByCount() {
        let transactions = [
            tx(date: 20_260_301, amount: -1000),
            tx(date: 20_260_315, amount: -2000),
            tx(date: 20_260_420, amount: -600),
            tx(date: 20_251_201, amount: -99999) // out of range: not counted
        ]
    ...
    @Test func avgPerMonthUsesFractionalMonths() {
        ...
        let transactions = [
            tx(date: 20_260_110, amount: -3000),
            tx(date: 20_260_310, amount: -3900)
        ]
    ...
    @Test func percentageDividesFilteredByDivisor() {
        ...
        let transactions = [
            tx(date: 20_260_301, amount: -2500, category: "groceries"),
            tx(date: 20_260_302, amount: -7500, category: "rent")
        ]
        let result = SummaryEngine.compute(meta: meta, transactions: transactions, today: asOf)
