...
struct SpendingEngineTests {
    ...
    @Test func currentMonthNetsRefunds() {
        let transactions = [
            tx(date: 20_260_501, amount: -10000),
            tx(date: 20_260_503, amount: 3000), // refund — nets against spending
            tx(date: 20_260_504, amount: -2000),
        ]
    ...
    @Test func currentMonthExcludesFutureDatedTransactions() {
        let transactions = [
            tx(date: 20_260_510, amount: -10000),
            tx(date: 20_260_520, amount: -5000), // after asOf (May 14) — excluded
        ]
        let result = SpendingEngine.compute(meta: meta(mode: .average), transactions: transactions, today: asOf)
    ...
    @Test func defaultModeIsSingleMonthVsPreviousMonth() {
        let transactions = [
            tx(date: 20_260_410, amount: -8000),
            tx(date: 20_260_420, amount: -9000), // past day 14 — excluded from comparison
            tx(date: 20_260_505, amount: -100),
        ]
    ...
    @Test func pinnedCompareMonthIsHonored() {
        let transactions = [
            tx(date: 20_260_305, amount: -4000),
            tx(date: 20_260_320, amount: -1000), // past day 14, still counts: full month
            tx(date: 20_260_210, amount: -2500),
            tx(date: 20_260_505, amount: -999), // current month — not the compare month
        ]
    ...
    @Test func averageOfPriorMonths() {
        ...
        let transactions = [
            tx(date: 20_260_210, amount: -10000), // Feb, within MTD cutoff
            tx(date: 20_260_310, amount: -10000), // Mar, within MTD cutoff
            tx(date: 20_260_410, amount: -10000), // Apr, within MTD cutoff
            tx(date: 20_260_420, amount: -50000), // Apr, after day 14 — excluded by MTD cutoff
            tx(date: 20_260_505, amount: -5000), // current month
        ]
        let result = SpendingEngine.compute(meta: meta(mode: .average), transactions: transactions, today: asOf)
        #expect(result.currentSpentCents == 5000)
    ...
    @Test func averageRangeSixMonths() {
        let transactions = [
            tx(date: 20_251_110, amount: -12000),
            tx(date: 20_251_210, amount: -12000),
            tx(date: 20_260_110, amount: -12000),
            tx(date: 20_260_210, amount: -6000),
            tx(date: 20_260_310, amount: -6000),
            tx(date: 20_260_410, amount: -6000),
        ]
    ...
    @Test func averageRangeYearToDate() {
        let transactions = [
            tx(date: 20_251_210, amount: -99000), // prior year — outside YTD
            tx(date: 20_260_110, amount: -8000),
            tx(date: 20_260_210, amount: -4000),
            tx(date: 20_260_310, amount: -4000),
            tx(date: 20_260_410, amount: -4000),
        ]
    ...
    @Test func averageRangeAllTime() {
        ...
        let transactions = [
            tx(date: 20_251_210, amount: -10000),
            tx(date: 20_260_505, amount: -100),
        ]
    ...
    @Test func singleMonthCompareTo() {
        let transactions = [
            tx(date: 20_260_301, amount: -7777), // March
            tx(date: 20_260_501, amount: -100), // current
        ]
        let result = SpendingEngine.compute(
    ...
    @Test func singleMonthRejectsNonCanonicalCompareDates() {
        let transactions = [
            tx(date: 20_260_101, amount: -1111),
            tx(date: 20_260_401, amount: -8888),
    ...
    @Test func budgetModeProratesBudgetThroughToday() {
        let budgets = [
            BudgetAnalysisBudgetEntry(month: 202_605, categoryId: "groceries", amountCents: 200_000),
            BudgetAnalysisBudgetEntry(month: 202_605, categoryId: "rent", amountCents: 110_000),
            BudgetAnalysisBudgetEntry(month: 202_604, categoryId: "rent", amountCents: 999_999), // other month — ignored
        ]
        ...
        #expect(result.comparisonCents == 140_000)
    }

    @Test func budgetModeUsesFullMonthForPastCompare() {
        let budgets = [BudgetAnalysisBudgetEntry(month: 202_603, categoryId: "rent", amountCents: 155_000)]
        let result = SpendingEngine.compute(
            meta: meta(compare: "2026-03", isLive: false, mode: .budget),
            transactions: [], budgets: budgets, categories: budgetCategories,
            categoryGroups: budgetGroups, today: asOf
        )
        #expect(result.comparisonCents == 155_000)
    }

    // getSpendingBudgetFilters: category conditions narrow the budgets too.
    @Test func budgetModeFiltersByCategoryConditions() {
        let budgets = [
            BudgetAnalysisBudgetEntry(month: 202_605, categoryId: "groceries", amountCents: 100_000),
            BudgetAnalysisBudgetEntry(month: 202_605, categoryId: "rent", amountCents: 200_000),
        ]
    ...
    @Test func budgetModeUnsupportedCategoryConditionSkipsFilter() {
        ...
        #expect(result.comparisonCents == 135_484)
    }
}
