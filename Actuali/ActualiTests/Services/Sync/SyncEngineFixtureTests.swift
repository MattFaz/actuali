...
struct HLCTimestampFixtureTests {
    ...
    @Test func ordering() throws {
        let mid = try #require(HLCTimestamp.parse("2015-04-24T22:23:42.123Z-1000-0123456789ABCDEF"))
...
struct SyncEncoderFixtureTests {
    ...
    @Test func syncRequestEncodesToUpstreamBytes() throws {
        let message = try CRDTMessage(
            timestamp: #require(HLCTimestamp.parse("2019-06-03T16:40:53.876Z-0000-9f66d38cba0ef956")),
            dataset: "accounts",
            row: "r1",
            column: "name",
            value: "S:Checking"
    ...
    @Test func plaintextRoundTrip() throws {
        let timestamp = try #require(HLCTimestamp.parse("2019-06-03T16:40:53.876Z-0000-9f66d38cba0ef956"))
