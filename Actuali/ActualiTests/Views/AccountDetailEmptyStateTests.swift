...
struct AccountDetailEmptyStateTests {
    ...
    @Test func noteSectionHidesWhenHiddenOrSearching() {
        #expect(AccountDetailView.showsNote(supported: true, hidden: false, isSearching: false))
        #expect(!AccountDetailView.showsNote(supported: true, hidden: true, isSearching: false))
        #expect(!AccountDetailView.showsNote(supported: true, hidden: false, isSearching: true))
        #expect(!AccountDetailView.showsNote(supported: false, hidden: false, isSearching: false))
    }
}
