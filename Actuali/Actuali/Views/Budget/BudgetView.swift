...
private struct BudgetListMetrics {
    ...
    init(style: BudgetDisplayStyle) {
        switch style {
        case .clean:
            self.sectionSpacing = .default
            self.horizontalContentMargin = 4
            self.topContentMargin = 20
            self.showsTopFade = true
        case .compact:
            self.sectionSpacing = .custom(0)
            self.horizontalContentMargin = 0
            self.topContentMargin = 0
            self.showsTopFade = false
        }
    }
}
