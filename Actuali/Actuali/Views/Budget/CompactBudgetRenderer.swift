...
struct CompactBudgetGroupHeader: View {
    ...
    var body: some View {
        ...
        .accessibilityHint(
            onSetHidden == nil
                ? String(localized: "Toggles the group's categories")
                : String(localized: "Tap to toggle the group's categories; touch and hold for options")
        )
...
struct CompactIncomeGroupHeader: View {
    ...
    var body: some View {
        ...
        .accessibilityHint(
            onSetHidden == nil
                ? String(localized: "Toggles the income categories")
                : String(localized: "Tap to toggle the income categories; touch and hold for options")
        )
        .foregroundStyle(.primary)
        .background(Color(.secondarySystemBackground))
        .opacity(isHidden ? 0.5 : 1)
